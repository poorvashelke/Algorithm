...
/*************************************************************************
 *
 *  Problem: Testing running times of AVL Tree
 *  Description: This Problem measures running time for Insertion and Search for AVL Tree
 *				
 ...
 *
 * Observation:
 * Observation of AVL tree is explained in HashChain.java
 *
 */
/**
...
public class AvlTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    public static void main( String [ ] args )
    {
        ...
        final int SMALL = 40;
        final int NUMS = 10000000;  // must be even
        final int GAP  =   1;
		...
		System.out.println("\nThe time taken by Find " + (System.nanoTime() - startTime) + " nanoseconds.");
